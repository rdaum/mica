...
export MICA_WT_FILEINS="${MICA_WT_FILEINS:-apps/shared/sync-host.mica apps/shared/string.mica apps/shared/events.mica apps/shared/llm.mica apps/agent/core.mica apps/agent/workspaces.mica apps/agent/tools.mica apps/shared/sync-dom.mica apps/agent/ui-session.mica apps/agent/transcript.mica apps/agent/ui-compose.mica apps/agent/ui-actions.mica apps/agent/http.mica}"
