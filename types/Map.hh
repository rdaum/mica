...
#include "base/association_protocol.hh"
...
typedef std::unordered_map<Var, Var, hash_var, std::equal_to<Var> > var_map;

class Map : public Data, public association_protocol<Var>, private var_map {
 public:
