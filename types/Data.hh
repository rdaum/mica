 ...
 */
class Data : public reference_counted, public type_protocol, public serializable {
 public:
  unsigned int guard;
 ...
 public:
  ...
  /** class invariant.
   */
  inline bool invariant() const { return Data::static_invariant(this); }
 ...
 public:
   ...
   */
  virtual Var declare(const Var &accessor, const Symbol &name, const Var &value);
   ...
   */
  virtual OptSlot get(const Var &accessor, const Symbol &name) const;
   ...
   *  @throws slot_not_found
   */
  virtual Var assign(const Var &accessor, const Symbol &name, const Var &value);
 ...
 public:
   ...
   */
  virtual var_vector perform(const Ref<Frame> &caller, const Var &args);
 ...
 */
child_set &operator<<(child_set &, const Var &);

void append_data(child_set &children, const Var &var);
void append_datas(child_set &children, const var_vector &one);
...
child_set data_triple(const Var &one, const Var &two, const Var &three);
};
