...
#include "base/collection_protocol.hh"
...
typedef std::unordered_set<Var, hash_var, std::equal_to<Var>, boost::pool_allocator<Var> > var_set;

class Set : public Data, public collection_protocol<Var>, private var_set {
 public:
 ...
 public:
   ...
   */
  inline bool truth() const { return null(); }

  /** @return false
   */
  inline bool isAtom() const { return false; }

  /** @return false
   */
  inline bool isNumeric() const { return false; }
