 ...
 *  Fits in 32-bits.
 */
class Var : boost::totally_ordered<Var>,     // >, >=, <=, etc.
 ...
 */
 ...
 private:
  ...
  inline bool is_float() const { return !v.atom.is_integer && v.atom.is_float; }
 ...
 */
 ...
 public:
  ...
  /** is the type numeric
   */
  bool isNumeric() const { return v.integer.is_integer; }
...
struct Slot {
  ...
  Slot(const Var &idefiner, const Var &ivalue) : definer(idefiner), value(ivalue) {}

  bool operator==(const Slot &cmp) const { return definer == cmp.definer && value == cmp.value; }
