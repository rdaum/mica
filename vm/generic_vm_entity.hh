...
namespace mica {
  ...
  public:
    ...
    virtual bool operator<(const Var &v2) const {
      return 0;
    }
       
    virtual Var add( const Var &rhs ) const { 
      throw invalid_type("invalid operands");
    }

    virtual Var div( const Var &rhs ) const {
      throw invalid_type("invalid operands");
    }

    virtual Var mul( const Var &rhs ) const {
      throw invalid_type("invalid operands");
    }

    virtual Var sub( const Var &rhs ) const {
      throw invalid_type("invalid operands");
    }

    virtual Var mod( const Var &rhs ) const  {
      throw invalid_type("invalid operands");
    }

    virtual Var pow( const Var &rhs ) const {
      throw invalid_type("invalid operands");
    }

    virtual Var neg() const {
      throw invalid_type("invalid operands");
    }

    virtual Var inc() const {
      throw invalid_type("invalid operands");
    }

    virtual Var dec() const {
      throw invalid_type("invalid operands");
    }

    virtual int toint() const {
      throw invalid_type("invalid type conversion");
    }
