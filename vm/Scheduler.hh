...
class Scheduler {
 private:
   ...
   */
  typedef std::unordered_map<Var, Ref<Task>, hash_var> VarTaskMap;
 ...
 public:
   ...
   */
  void send_nonblock(size_t age, size_t ticks, const Var &source, const Var &from, const Var &to,
                     const Var &on, const Symbol &selector, const var_vector &args);
