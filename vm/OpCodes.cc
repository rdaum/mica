...
void Frame::op_closure( unsigned int param_1, unsigned int param_2 )
{
  push( Var(make_closure()) );
}
...
void
Frame::op_self( unsigned int param_1, unsigned int param_2 )
{
  push(Var(self));
}


void Frame::op_continue( unsigned int param_1, unsigned int param_2 )
{
  loop_continue();
}

void Frame::op_break( unsigned int param_1, unsigned int param_2 )
{
  loop_break();
}
...
void
Frame::op_join( unsigned int param_1, unsigned int param_2 ) {
...
void
Frame::op_if( unsigned int param_1, unsigned int param_2 )
{
  /** Pop success branch
   */
  Var success(pop());
...
void
Frame::op_ifelse( unsigned int param_1, unsigned int param_2 )
{
  /** Pop fail branch
   */
  Var fail(pop());
...
void
Frame::op_throw( unsigned int param_1, unsigned int param_2 )
{
  /** Pop error
   */
  Var err(pop());
...
void Frame::op_pop( unsigned int param_1, unsigned int param_2 )
{
  pop();
}
...
void Frame::op_ticks( unsigned int param_1, unsigned int param_2 )
{
  push( Var( (int)ticks ) );
}

void Frame::op_caller( unsigned int param_1, unsigned int param_2 )
{
  push( caller );
}

void Frame::op_source( unsigned int param_1, unsigned int param_2 )
{
  push( source );
}

void Frame::op_selector( unsigned int param_1, unsigned int param_2 )
{
  push( Var(selector) );
}

void Frame::op_args( unsigned int param_1, unsigned int param_2 )
{
...
void Frame::op_slots( unsigned int param_1, unsigned int param_2 )
{
  push( self.slots() );
}
