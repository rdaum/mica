 ...
 */
class Task : public generic_vm_entity {
 public:
  Type::Identifier type_identifier() const { return Type::TASK; }
 ...
 public:
   ...
   */
  Task(Ref<Task> parent, size_t msgid, int pool_id = -1);
 ...
 public:
   ...
   */
  Var send(const Var &source, const Var &from, const Var &to, const Var &on, const Symbol &selector,
